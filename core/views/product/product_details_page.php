<div style="min-height: 100vh;" class="container  py-5">
    ...
    <div class="pt-5 px-1 row">
        ...
        <div style="height:fit-content;" class="col-md-12 col-sm-12 mb-5 d-flex gap-2 px-0 ">
            ...
            <img class="img-fluid  w-50  " style=" max-height:400px" src="<?= $data['product_details']['img_src']; ?>"
                alt="...">
            ...
            <div class="w-50  d-flex flex-column p-3  ">
                ...
                <a href="?a=contact_store_page/<?= $data['product_details']['id']; ?>" style="width: fit-content"
                    class="btn btn-success mt-4 btn-sm">Entrar em contato</a>

                <?php if (isset($_SESSION['error'])): ?>

                    <div class="alert alert-danger d-flex mt-3 gap-3 align-items-center justify-content-center"
                        role="alert">
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <div class="mt-3 ">
                    ...
                    <form class="flex-column px-0 mb-5 py-1  "
                        action="?a=make_question&product_id=<?= $data['product_details']['id']; ?>" method="POST">
                        ...
                        <button id="btn-form-submit" type="submit" name="submit"
                            ...
                            style="width: fit-content;">Enviar</button>
                    ...
                    <div class="">
                        ...
                        <?php if ($data['answer'] != ''): ?>
                            ...
                            <div style="width:fit-content" class="d-flex gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#909090"
                                    class="bi bi-arrow-return-right mt-1" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
