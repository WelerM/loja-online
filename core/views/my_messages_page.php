                    ...
                    <div class="mt-3 mb-1 shadow-sm p-2 rounded-1 border">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <p style="font-size:13px" class="m-0">
                                <?= date('d/m/Y', strtotime($data['created_at'])) . ' às ' . date('H:i', strtotime($data['created_at'])) . 'h' ?>
                            </p>
                        </div>
                        ...
                        <div style="width:fit-content" class="d-flex gap-2">
                            ...
                            <div class="border rounded shadow-sm p-2">
                                ...
                                <div class="d-flex flex-row justify-content-between align-items-center">
                                    ...
                                    <p style="font-size:13px" class="m-0">
                                        <?= date('d/m/Y', strtotime($data['answer_created_at'])) . ' às ' . date('H:i', strtotime($data['answer_created_at'])) . 'h' ?>
                                    </p>
                                </div>
