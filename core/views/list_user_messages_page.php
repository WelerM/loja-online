<div style="min-height:100vh" class="container  mx-auto py-5">
        ...
        <?php foreach ($data as $message): ?>
            ...
            <div style="width: w-100;" class="row border p-0 my-3 rounded shadow-sm ">
                ...
                <div class="col-8 border-0 border-end p-3">
                    ...
                    <div style="height: fit-content;" class="d-flex gap-1 mt-2  ">
                        ...
                        <a class="btn btn-success btn-sm"
                            href="?a=answer_user_message_page/user_id=<?= $message["user_id"] ?>&product-id=<?= $message['product_id'] ?>">Responder</a>
                ...
                <div class="col-auto p-3">
                    ...
                    <img src="<?= $message['product_img_src'] ?>" class="img-fluid" style="max-width: 60px; height: 60px"
                        alt="">
