<div style="min-height: 100vh;" class="container py-5">
    ...
    <?php foreach ($data as $product) : ?>
        ...
        <div class="d-flex justify-content-between border w-50 my-3 p-2 rounded shadow ">

            <div style="height: 100px;" class="card d-flex flex-row gap-3 border-0">

                <img style="width:100px" src="<?= $product['img_src']; ?>" class="card-img-top img-fluid m-0 p-0" alt="...">
